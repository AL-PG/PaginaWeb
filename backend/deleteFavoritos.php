...
if ($_SERVER['REQUEST_METHOD'] === 'DELETE') {
    ...
    // Eliminar el registro de favoritos
    $stmt = $conn->prepare("DELETE FROM Favoritos WHERE idUsuario = ? AND idProducto = ?");
    ...
    try {
        ...
        if ($stmt->affected_rows === 0) {
            ...
            echo json_encode(["error" => "El producto no estaba en favoritos"]);
        } else {
